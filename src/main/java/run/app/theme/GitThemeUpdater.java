package run.app.theme;

import static run.app.theme.ThemeUpdater.backup;
import static run.app.theme.ThemeUpdater.restore;
import static run.app.utils.GitUtils.commitAutomatically;
import static run.app.utils.GitUtils.logCommit;
import static run.app.utils.GitUtils.removeRemoteIfExists;
