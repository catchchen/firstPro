...
import static run.app.model.support.HaloConst.API_ACCESS_KEY_HEADER_NAME;
import static run.app.model.support.HaloConst.API_ACCESS_KEY_QUERY_NAME;
import static run.app.model.support.HaloConst.HALO_VERSION;
import static run.app.utils.SwaggerUtils.customMixin;
import static run.app.utils.SwaggerUtils.propertyBuilder;
...
import run.app.utils.SwaggerUtils;
...
public class SwaggerConfiguration {
    ...
    public Docket haloDefaultApi() {
        return buildApiDocket("run.app.content.api",
            "run.app.controller.content.api",
            "/api/content/**")
    ...
    public Docket haloAdminApi() {
        return buildApiDocket("run.app.admin.api",
            "run.app.controller.admin",
            "/api/admin/**")
